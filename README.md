...
- **$\textcolor{#90E4C1}{\textbf{Linear\ Regression}}$**: As a baseline model.
- **$\textcolor{#FF7777}{\textbf{Decision\ Tree\ and\ Random\ Forest\ Regressors}}$**: For capturing non-linear relationships.
